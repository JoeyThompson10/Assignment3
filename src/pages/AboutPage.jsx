  ...
  return (
    <div className="about-page">
      ...
      <ul>
        ...
        <li><strong>Cloud Database Interaction:</strong> Demonstrates how to connect a React frontend with a cloud-hosted database.</li>
      </ul>
      <h3>Technologies Used</h3>
      <p>The app is built using React, with Axios for API requests. It interfaces with a MongoDB, showcasing how cloud computing is integrated into frontend development.</p>
